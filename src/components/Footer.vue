<template>
  <footer class="bg-dark-blue">
    <div class="flex flex-col items-center justify-center gap-[32px] pt-[40px] pb-[48px] lg:mx-auto lg:grid lg:w-[1100px] lg:grid-cols-[280px_180px_180px_1fr] lg:gap-0">
      <div class="flex flex-col items-center gap-[32px] lg:items-start lg:gap-[56px]">
      ...
      <div class="flex flex-col items-center gap-[24px] leading-[100%] text-white lg:items-start">
        <a href="#">About Us</a>
        <a href="#">Contact</a>
        <a href="#">Blog</a>
      </div>
      <div class="mt-[-8px] flex flex-col items-center gap-[24px] leading-[100%] text-white lg:items-start">
        <a href="#">Careers</a>
        <a href="#">Support</a>
        <a href="#">Privacy Policy</a>
      </div>
      <div class="flex flex-col items-center gap-[24px] lg:items-end">
        <RequestInviteButton />
        <p class="text-grayish-blue">@ Easybank. All Rights Reserved.</p>
      </div>
    </div>
  </footer>
</template>
